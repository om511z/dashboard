...
import { newKurta, getAdminProducts, clearErrors, deleteKurta } from '../../actions/kurtaAction';
import { DELETE_KURTA_RESET, NEW_KURTA_RESET } from '../../constants/kurtConstants';
import { Button, Form, Input, message, Modal, Select, Table } from "antd";

const Kurtas = ({ history }) => {
    ...
    const { loading, error, success } = useSelector(state => state.newKurta);
    const {error:deleteError,isDeleted} = useSelector(state =>state.deletekurta)
    ...
    useEffect(() => {
        ...
        if(isDeleted) {
           ...
           history.push('/jacket');
           dispatch({type: DELETE_KURTA_RESET })
