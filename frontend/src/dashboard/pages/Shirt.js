...
import { newShirt,getAdminProducts,deleteShirt,clearErrors } from '../../actions/shirtAction'
import { DELETE_SHIRT_RESET, NEW_SHIRT_RESET } from '../../constants/shirtConstant'
...
const Shirt = ({history}) => {
    ...
    const {error:deleteError,isDeleted} = useSelector(state =>state.deleteshirt)
    ...
    useEffect(()=>{
        ...
        if(isDeleted) {
           ...
           history.push('/jacket');
           dispatch({type: DELETE_SHIRT_RESET })
